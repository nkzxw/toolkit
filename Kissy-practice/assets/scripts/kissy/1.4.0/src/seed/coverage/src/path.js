...
function visit543_212_2(result) {
...
function visit537_189_1(result) {
  _$jscoverage['/path.js'].branchData['189'][1].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['177'][3].init(158, 38, 'basename.slice(-1 * ext.length) == ext');
function visit536_177_3(result) {
  _$jscoverage['/path.js'].branchData['177'][3].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['177'][2].init(146, 50, 'basename && basename.slice(-1 * ext.length) == ext');
function visit535_177_2(result) {
  _$jscoverage['/path.js'].branchData['177'][2].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['177'][1].init(139, 57, 'ext && basename && basename.slice(-1 * ext.length) == ext');
function visit534_177_1(result) {
  _$jscoverage['/path.js'].branchData['177'][1].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['176'][1].init(106, 15, 'result[3] || \'\'');
function visit533_176_1(result) {
...
function visit532_174_1(result) {
  _$jscoverage['/path.js'].branchData['174'][1].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['155'][1].init(715, 28, 'sameIndex < fromParts.length');
function visit531_155_1(result) {
  _$jscoverage['/path.js'].branchData['155'][1].ranCondition(result);
  return result;
}_$jscoverage['/path.js'].branchData['148'][1].init(21, 42, 'fromParts[sameIndex] != toParts[sameIndex]');
function visit530_148_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit516_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit517_65_1(visit518_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit519_67_1(visit520_67_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit521_71_1(path.charAt(0) == '/');
  }
  ...
  return visit522_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit523_92_1(path.charAt(0) == '/'), trailingSlash = visit524_93_1(path.slice(-1) == '/');
  ...
  if (visit525_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit526_103_1(path && trailingSlash)) {
  ...
  return visit527_118_1(p && (visit528_118_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit529_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit530_148_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit531_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit532_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit533_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit534_177_1(ext && visit535_177_2(basename && visit536_177_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit537_189_1(path.match(splitPathRe) || []), root = visit538_190_1(result[1] || ''), dir = visit539_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit540_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit541_198_1(dir)) {
  ...
  return visit542_212_1((visit543_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
