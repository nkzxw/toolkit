$.fn.infiniteCarousel = function (wrapperSelector) {
    ...
    return this.each(function () {
        ...
        //alert(singleWidth+' : '+$wrapper.innerWidth()+' : '+visible+ " : "+pages)
...
$(function () {
    var lists = $('.s-g-content ul li');
    if (lists.length > 4) {
        $('#J_slider-gallery > div')
            .before('<a class="back" href="#"><</a>')
            .after('<a class="forward" href="#"></a>')
            .parent().infiniteCarousel('> div');
    }
});
